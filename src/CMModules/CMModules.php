<?php
/**
 * A model for managing Anton modules.
 * 
 * @package AntonCore
 */
class CMModules extends CObject {
   ...
   * Properties
   */
  private $antonCoreModules = array('CAnton', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $antonCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isAntonCore']   = in_array($rc->name, $this->antonCoreModules);
      $details['isAntonCMF']    = in_array($rc->name, $this->antonCMFModules);
